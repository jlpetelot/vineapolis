...
class RegistervigneronController extends Controller
{
    /*
    |--------------------------------------------------------------------------
    | Register Controller
...
//    {
//        return view('auth.registervigneron');
//    }
    ...
    /**
     * Métode registervigneronpost () qui surclasse la méthode register /vendor/illuminate/laravel d'origine
     *
     * @param  \Illuminate\Http\Request  $request
     * @return \Illuminate\Http\Response
     */
    public function registervigneronpost (Request $request)
    {
        abort(401);
    }
