...
class RegisterannonceurController extends Controller
{
    /*
    |--------------------------------------------------------------------------
    | Register Controller
    ...
    */
    ...
    {
        // return view('auth.registerannonceur');
        abort(401);
    }

    /**
     * Métode registerannonceurpost () qui surclasse la méthode register /vendor/illuminate/laravel d'origine
     *
     * @param  \Illuminate\Http\Request  $request
     * @return \Illuminate\Http\Response
     */
    public function registerannonceurpost (Request $request)
    {
