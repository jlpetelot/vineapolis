...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <a href="{{ url('password/reset') }}" style="color: #00a7d0">J'ai oublié mon mot de passe</a>
        <div class="pull-right" style="font-weight: 500;"><a href="{{ route('register') }}">
                Je souhaite m'inscrire</a><br>
        </div>
        <br/>
