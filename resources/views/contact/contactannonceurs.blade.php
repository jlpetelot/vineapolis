        ...
        <div id="cadrecontact"><!-- cadrecontact -->
            ...
            <div class="col-xs-12 margehaute60px"><!-- col-xs-12 -->
                <h3 style="margin-bottom: 20px;">
                    Vous êtes une entreprise ou un indépendant et souhaitez annoncer sur le site Vineapolis.
                </h3>
                <p>
                    ...
                    <div class="form-horizontal">
                        <div class="form-group {{ $errors->has('societe') ? 'has-error': '' }}">
                            <div class="col-xs-8">
                                ...
                                {{--</small>--}}
                                {!! Form::label('societe', 'Votre nom ou société') !!}
                            </div>
                            <div class="col-xs-8">
                                {!! Form::text('societe', null,
                                ['class' => 'form-control4',
                                'placeholder' => 'Par exemple : Entreprise Richer']) !!}
                    ...
                    <div class="form-horizontal">
                        <div class="form-group {{ $errors->has('email') ? 'has-error': '' }}">
                            ...
                            <div class="col-xs-8">
                                ...
                                'Par exemple : contact@richer.com'
                                ]) !!}
                                @if ($errors->has('email'))
