...
<div class="row"><!-- row -->
    <div class="col-md-12"><!-- col-lg-12 -->
        <div id="cadrecontact"><!-- cadrecontact -->
            ...
            <!--====================== LE FORMULAIRE DE CONTACT POUR LES VIGNERONS AVEC ADRESSE =================-->
            <div class="col-xs-12 margehaute60px"><!-- col-xs-12 -->
                ...
                <p>
                    Envoyez-nous vos coordonnées pré-remplies ci-dessous.
                    <br/>Et vous revevrez votre accréditation ajoutée de vos identifiants
