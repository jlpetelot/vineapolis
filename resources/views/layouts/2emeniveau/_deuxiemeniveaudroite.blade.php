...
$publicite6 = App\Publicite::where('categorie', '2emeniveau-droite-haut')->inRandomOrder()->first();
$publicite7 = App\Publicite::where('categorie', '2emeniveau-droite-haut')->inRandomOrder()->first();
$publicite8 = App\Publicite::where('categorie', '2emeniveau-droite-bas')->inRandomOrder()->first();
?>
<!-- =========================== ../LES REQUÊTES EN DIRECT PAR LA VUE ============================-->
