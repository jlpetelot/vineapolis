        ...
        <div class="row">
            <div class="col-md-12" id="modalentetegoogle"><!-- col-md-12 -->
                <div class="col-md-5 margehaute10px">
                    <h3 class="rougesaintjulien gras">
                        Tous vos vins de {{ $vinzoom->localitevinicole }} sur Google Map
                    </h3>
                </div>
...
<script type="text/javascript">
    ...
    window.onload = function ()
    {
        ...
        var domaine = "{{ asset('img/marker.png') }}";

        // On créé la variable de locations
        var locations;
        ...
        var map = new google.maps.Map(document.getElementById('cartegoogle'), {
            zoom: {{ $vinzoom->zoom }},
            center: new google.maps.LatLng({{ $vinzoom->latlongregion }}),
            mapTypeControl: true,
