...
<div class="register-box">
    <div class="register-logo">
        <span style="font-weight: 700; color: #860043">Internaute</span>
    ...
    <div class="register-box-body">
        ...
        <form action="{{ route('registerinternautepost') }}" method="post">
            {{ csrf_field() }}
        ...
        <a href="{{ route('logininternaute') }}" class="text-center">Je suis déjà inscrit</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
