...
{!! Form::model($annonceur, [
    'method'    => 'PUT',
    'route'     => ['admin.annonceurs.update', $annonceur->id],
    'files'      => true
]) !!}
...
<div class="form-horizontal">
    <div class="form-group {{ $errors->has('adresse') ? 'has-error': '' }}">
        ...
        <div class="col-xs-10">
            ...
            ['class' => 'form-control',
            'placeholder' => 'Par exemple : 5, rue des Aloutettes, 81000 Albi']) !!}
...
<!-- Site internet -->
<div class="form-horizontal {{ $errors->has('urlsite') ? 'has-error': ''}}">
    <div class="form-group">
        <div class="col-xs-2 control-label">
            {!! Form::label('urlsite', 'Site internet') !!}
        </div>
        <div class="col-xs-10">
            {!! Form::text('urlsite', null, ['class' => 'form-control',
            'placeholder' => 'Par exemple : http://www.Andre-et-fils.com']) !!}
 ...
 <div class="form-horizontal">
    <div class="form-group  {{ $errors->has('image') ? 'has-error': '' }}">
        <div class="col-xs-2 control-label">
            ...
            <br/><small>Se baser sur les dimensions du choix de l'annonce. <br/>Par exemple : (191px) x (238px)</small>)
        </div>
...
<div class="form-horizontal">
    <div class="form-group">
        ...
        <div class="col-xs-10">
            {!! Form::submit('Mise à jour', ['class' => 'btn btn-warning']) !!}
            &nbsp;
