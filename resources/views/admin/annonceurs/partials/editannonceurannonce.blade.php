...
<div class="col-xs-offset-1">
    ...
    {!! Form::model($pub, [
        'method'    => 'PUT',
        'route'     => ['admin.annonceurs.updateannonce', $pub->id],
        'files'      => true
    ]) !!}
    
    <!-- Le choix de l'annonce -->
    <h4 style="margin-top:10px; margin-bottom: 0">Annonce N° {{ $pub->id }}</h4>
    <div class="form-horizontal">
        <div class="form-group {{ $errors->has('pub') ? 'has-error': '' }}">
                <div class="col-xs-4" style="margin-top:7px">
                    {!! Form::label('pub', "$pub->categorie, $pub->label, format : $pub->format") !!}
                </div>
            <div class="col-xs-8">
                {{ Form::select('pub', 
                [
                ...
                [
                    'class' => 'form-control',
                    'placeholder' => "Sélectionnez l'annonce à mettre à jour"
                ]) }}
                @if ($errors->has('pub'))
    ...
    <div class="form-horizontal">
        <div class="form-group  {{ $errors->has('image') ? 'has-error': '' }}">
            <div class="col-xs-4">
                {!! Form::label('image', "Le visuel de l'annonce à mettre à jour si besoin est") !!}
