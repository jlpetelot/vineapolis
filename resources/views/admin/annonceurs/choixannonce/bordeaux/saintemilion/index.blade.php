                ...
                <div class="box-header with-border">
                    <h4>{{ $annonceur->societe }} | 
                        <span style="color: #f39c12">
                            Vous avez choisi les communes de Saint-Emilion
                            [&nbsp;<img src="{{ asset('backend/img/Saint-Emilion_admin.jpg') }}" 
                    ...
                    <div class="col-xs-12" style="margin-top:-40px">
                        ...
                        {!! Form::open([
                            'method'    => 'POST',
                            'route'     => ['admin.annonceurs.choixannonce.saintemilion.validation', $annonceur->id],
                        ]) !!}
                        <!-- Les erreurs -->
