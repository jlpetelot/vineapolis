    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Niveau tous les vins</li>
            </ol>
        </section>
        <!-- Main content -->
                ...
                <div class="box-header with-border">
                    <h4>{{ $annonceur->societe }} | 
                        <span style="color: #f39c12">
                            Vous avez choisi Tous les vins
                            [&nbsp;<img src="{{ asset('backend/img/Savoie_admin.jpg') }}" 
                            class="img-circle" width="7%" height="auto">&nbsp;]
                        </span>
                    </h4>
                    <br/>
                    <div class="col-xs-12" style="margin-top:-40px">
                            C'est-à-dire une présence au chœur même de tous les vignerons.
                            <p> 1 seul format, 1 seul tarif. Choisissez parmi les annonces proposées et confirmez votre choix, si vous le voulez bien.
                            </p>
                            <p style="padding-top:15px"> &bull; 1 seul format de (198px) x (238px) à 1 990€ HT (*)</p>
                        ...
                        {!! Form::open([
                            'method'    => 'POST',
                            'route'     => ['admin.annonceurs.choixannonce.touslesvins.validation', $annonceur->id],
                        ]) !!}
                        <!-- Les erreurs -->
