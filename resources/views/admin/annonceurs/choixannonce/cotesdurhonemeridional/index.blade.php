                ...
                <div class="box-header with-border">
                    <h4>{{ $annonceur->societe }} | 
                        <span style="color: #f39c12">
                            Vous avez choisi les communes des Côtes du Rhône Méridional
                            [&nbsp;<img src="{{ asset('backend/img/Côtes-du-Rhône-Méridional_admin.jpg') }}" 
                    ...
                    <div class="col-xs-12" style="margin-top:-40px">
                        ...
                        {!! Form::open([
                            'method'    => 'POST',
                            'route'     => ['admin.annonceurs.choixannonce.cotesdurhonemeridional.validation', $annonceur->id],
                        ]) !!}
                        <!-- Les erreurs -->
