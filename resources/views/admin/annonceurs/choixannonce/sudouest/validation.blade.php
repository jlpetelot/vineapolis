                ...
                <div class="box-header with-border">
                    <h4>{{ $annonceur->societe }} | 
                        <span style="color: #f39c12">
                            Vous avez choisi l'espace {{ $pub->label }} dans la région de {{ $pub->categorie }}
                    ...
                    <div class="col-xs-12" style="margin-top:-50px">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                &nbsp;<a href="{{ route('admin.annonceurs.choixannonce.bordeaux', $annonceur->id) }}" type="button" class="btn btn-info">Modifiez</a>
