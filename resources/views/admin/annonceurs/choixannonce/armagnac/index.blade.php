                ...
                <div class="box-header with-border">
                    <h4>{{ $annonceur->societe }} | 
                        <span style="color: #f39c12">
                            Vous avez choisi la région de l'Armagnac
                            [&nbsp;<img src="{{ asset('backend/img/Armagnac_admin.jpg') }}" 
                    ...
                    <div class="col-xs-12" style="margin-top:-40px">
                        ...
                        {!! Form::open([
                            'method'    => 'POST',
                            'route'     => ['admin.annonceurs.choixannonce.armagnac.validation', $annonceur->id],
                        ]) !!}
                        <!-- Les erreurs -->
