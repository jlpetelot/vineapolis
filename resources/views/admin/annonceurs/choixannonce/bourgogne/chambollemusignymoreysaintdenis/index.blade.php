                ...
                <div class="box-header with-border">
                    <h4>{{ $annonceur->societe }} | 
                        <span style="color: #f39c12">
                            Vous avez choisi les communes de Chambolle-Musigny et Morey-Saint-Denis
                            [&nbsp;<img src="{{ asset('backend/img/Chambolle-Musigny-Morey-Saint-Denis_admin.jpg') }}" 
                    ...
                    <div class="col-xs-12" style="margin-top:-40px">
                        ...
                        {!! Form::open([
                            'method'    => 'POST',
                            'route'     => ['admin.annonceurs.choixannonce.chambollemusignymoreysaintdenis.validation', $annonceur->id],
                        ]) !!}
                        <!-- Les erreurs -->
