                ...
                <div class="box-header with-border">
                    <h4>{{ $annonceur->societe }} | 
                        <span style="color: #f39c12">
                            Vous avez choisi les communes de Vosne-Romanée
                            [&nbsp;<img src="{{ asset('backend/img/Vosne-Romanée_admin.jpg') }}" 
                    ...
                    <div class="col-xs-12" style="margin-top:-40px">
                        ...
                        {!! Form::open([
                            'method'    => 'POST',
                            'route'     => ['admin.annonceurs.choixannonce.vosneromanee.validation', $annonceur->id],
                        ]) !!}
                        <!-- Les erreurs -->
