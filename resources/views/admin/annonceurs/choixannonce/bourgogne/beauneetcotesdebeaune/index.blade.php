                ...
                <div class="box-header with-border">
                    <h4>{{ $annonceur->societe   }} | 
                        <span style="color: #f39c12">
                            Vous avez choisi la région de Beaune et Côtes de Beaune
                            [&nbsp;<img src="{{ asset('backend/img/Beauneetcotesdebeaune_admin.jpg') }}" 
                            class="img-circle" width="7%" height="auto">&nbsp;]
                        </span>
                    </h4>
                    <br/>
                    <div class="col-xs-12" style="margin-top:-60px">
                        <p> 3 formats, 3 tarifs différents.
                        </p>
                        <p> &bull; Le plus grand format : (382px) x (440px) à 2 990€ HT (*)</p>
                        ...
                        {!! Form::open([
                            'method'    => 'POST',
                            'route'     => ['admin.annonceurs.choixannonce.beauneetcotesdebeaune.validation', $annonceur->id],
                        ]) !!}
                        <!-- Les erreurs -->
