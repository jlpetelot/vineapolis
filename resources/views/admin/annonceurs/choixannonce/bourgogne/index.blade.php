                ...
                <div class="box-header with-border">
                    <h4>{{ $annonceur->societe }} | 
                        <span style="color: #f39c12">
                            Vous avez choisi la région de Bourgogne
                            [&nbsp;<img src="{{ asset('backend/img/Bourgogne_admin.jpg') }}" 
                    ...
                    <div class="col-xs-12" style="margin-top:-60px">
                        ...
                        {!! Form::open([
                            'method'    => 'POST',
                            'route'     => ['admin.annonceurs.choixannonce.bourgogne.validation', $annonceur->id],
                        ]) !!}
                        <!-- Les erreurs -->
