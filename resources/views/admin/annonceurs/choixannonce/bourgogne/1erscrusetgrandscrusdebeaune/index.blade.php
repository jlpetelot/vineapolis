                ...
                <div class="box-header with-border">
                    <h4>{{ $annonceur->societe }} | 
                        <span style="color: #f39c12">
                            Vous avez choisi les communes des 1ers crus et Grands Crus de Beaune
                            [&nbsp;<img src="{{ asset('backend/img/1ers-crus-et-Grands-Crus-de-Beaune_admin.jpg') }}" 
                    ...
                    <div class="col-xs-12" style="margin-top:-40px">
                        ...
                        {!! Form::open([
                            'method'    => 'POST',
                            'route'     => ['admin.annonceurs.choixannonce.1erscrusetgrandscrusdebeaune.validation', $annonceur->id],
                        ]) !!}
                        <!-- Les erreurs -->
