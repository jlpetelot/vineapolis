            ...
            <div class="box-header"><!-- box-header -->
                <div class="col-xs-8"><!-- col-xs-8 -->
                    <h4><span style="color: #f39c12; font-weight: 600">
                        {{ $annonceur->societe }} | </span>Vous souhaitez régler votre commande.
                    </h4>
                    <br/>
                    <p>
                        ...
                        @endif
                        <br/>Le montant total de votre achat : {{ number_format($carte, 2, ',', ' ') }} € TTC.
                        <p>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade in active" role="tabpanel" id="home" aria-labelledby="home-tab">
                                ...
                                {{ Form::model($annonceur, [
                                    'method' => 'POST',
                                    'route' => ['admin.annonceurs.paiement.stripe', $annonceur->id]
                                ]) }}
                                {!! Form::hidden("product_id", $product_id) !!}
                                    <script
                                        src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                                        data-label="Payez ma commande de {{ number_format($carte, 2, ',', ' ') }} € TTC"
                                ...
                                {{ Form::close() }}
                                <div style="display: block; position: fixed; margin: -33px 0 0 265px">
                                    {!! Form::model($annonceur, [
                                         'method'    => 'POST',
                            ...
                            <div class="tab-pane fade" role="tabpanel" id="profile" aria-labelledby="profile-tab">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            <a href="{{ route('admin.annonceurs.paiement.paypal', $annonceur->id) }}"
                                               type="button" class="btn btn-primary">Payez ma commande de {{ number_format($carte, 2, ',', ' ') }} € TTC</a>
                                        </div>
                                    </div>
                                </div>
                                <div style="display: block; position: fixed; margin: -49px 0 0 258px">
                                    {!! Form::model($annonceur, [
                                         'method'    => 'POST',
                                         'route'     => ['admin.annonceurs.annulation', $annonceur->id]
                                    ]) !!}
